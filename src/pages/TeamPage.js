  ...
  return (
    <div className="team-page">
      ...
      <div className="team-page-content">
        ...
        {/* Logo Card - Only for owners */}
        {isTeamOwner && (
          <div className="team-page-card">
            <div className="team-page-card-header">
              <div>
                <h2 className="team-page-card-title">Team-logotyp</h2>
                <p className="team-page-card-subtitle">Visas i sidomenyn och på PDF-rapporter</p>
              </div>
            </div>
            <div className="team-page-card-body">
              <div className="team-page-logo-section">
                <div className="team-page-logo-preview">
                  {currentTeam.logoUrl ? (
                    <img src={currentTeam.logoUrl} alt="Team logo" className="team-page-logo-image" />
                  ) : (
                ...
                <div className="team-page-logo-controls">
                  <input
                    ref={fileInputRef}
                    type="file"
                    accept="image/jpeg,image/png,image/gif,image/webp"
                    onChange={handleLogoChange}
                    className="team-page-file-input"
                  />
                  <button
                  ...
                  <p className="team-page-logo-hint">
                    Rekommenderad storlek: 200x60 px. Max 2MB. PNG eller JPG.
                  </p>
                </div>
              </div>
            </div>
